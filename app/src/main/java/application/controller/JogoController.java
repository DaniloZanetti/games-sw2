...
public class JogoController {
    ...
    public String update(@RequestParam("id") int id, @RequestParam("titulo") String titulo, @RequestParam("multiplayer") Boolean multiplayer, @RequestParam("genero") Long generoId) {
        Optional<Jogo> result = jogosRepo.findById(id);
        if(result.isPresent()) {
